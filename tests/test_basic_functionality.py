...
class TestBasicFunctionality:
    ...
    def test_increase_counter_of_ingredient_after_drag_and_drop(self, driver_start):
        ...
        counter = class_object.find_element_with_wait_for_changing_text(MainPageLocators.COUNTER_OF_SOUSE, driver_start)
    ...
    def test_create_order_after_authorization(self, driver_start, create_and_delete_user):
        ...
        order_number = (second_class_object.find_element_with_wait_for_changing_text
